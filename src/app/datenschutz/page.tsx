...
export const metadata: Metadata = {
  ...
  description: "Datenschutzerklärung von admin4me. Informationen zur Verarbeitung personenbezogener Daten gemäß DSGVO.",
};
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-8 border border-gray-200 dark:border-gray-700">
          <div className="space-y-8 text-gray-600 dark:text-gray-300">
            ...
            <div>
              ...
              <p>
                Wir hosten unsere Website bei einem professionellen Hosting-Dienstleister. Die Datenschutzerklärung 
                des Hosting-Anbieters ist auf dessen Website verfügbar. Wir verwenden keine Cookies oder Tracking-Tools 
                auf dieser Website.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                Rechtsgrundlagen wird in den Absätzen dieser Datenschutzerklärung informiert.
              </p>
            </div>

    ...
    <div className="mx-auto max-w-content px-4 sm:px-6 lg:px-8 py-16">
      ...
      <section className="mb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          {/* QR-Codes Rechts */}
          <div className="lg:border-l border-gray-200 dark:border-gray-600 lg:pl-20">
            <h2 className="heading-md text-professional dark:text-white mb-10 text-center">
              Schnellkontakt
            </h2>
            <p className="text-enhanced text-gray-600 dark:text-gray-300 mb-16 text-center leading-relaxed tracking-wide">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
              ...
              <div className="text-center">
                <div className="w-44 h-44 mx-auto mb-8 bg-gradient-to-br from-green-100 to-green-200 dark:from-green-900 dark:to-green-800 rounded-2xl flex items-center justify-center shadow-professional hover-lift transition-all duration-300 p-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 font-semibold tracking-wide">
                  WhatsApp Chat
                </p>
              </div>
              ...
              {/* Telegram QR Code */}
              <div className="text-center">
                <div className="w-44 h-44 mx-auto mb-8 bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 rounded-2xl flex items-center justify-center shadow-professional hover-lift transition-all duration-300 p-6">

  ...
  return (
    <div className="mx-auto max-w-content px-4 sm:px-6 lg:px-8 py-16">
      ...
      <section className="text-center mb-24">
        ...
        <p className="text-subtitle dark:text-gray-300 mb-6">
          IT-Administration & Support
        </p>
        <p className="text-enhanced text-gray-700 dark:text-gray-300 mb-16 max-w-3xl mx-auto">
          Schnelle Hilfe, persönliche Betreuung, zuverlässiger Betrieb
        </p>
        
        {/* Hero Illustration Placeholder */}
        <div className="w-80 h-56 mx-auto mb-16 bg-gradient-accent rounded-2xl shadow-lift flex items-center justify-center animate-subtle-float">
      ...
      <section className="mb-24">
        <h2 className="heading-lg text-professional dark:text-white text-center mb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="problem-box hover-lift">
            ...
            <Link href="/leistungen" className="inline-flex items-center mt-6 text-sm font-semibold text-accent hover:text-professional transition-colors">
              Mehr erfahren →
            </Link>
          </div>
